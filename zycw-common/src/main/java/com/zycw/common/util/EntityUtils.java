 ...
 * </p>
 * <p>
 * Description: 解决问题： 1、快速对实体的常驻字段，如：crtUser、crtHost、updUser等值快速注入
 * </p>
 * @author   yangjunxu
 * @version  1.0
 * @since 
...
public class EntityUtils {
	...
	public static <T> void setCreateInfo(T entity){
		...
		System.out.println("hostIp>>>"+hostIp+",name>>>"+name+",id>>>"+id);
		// 默认属性
	...
	public static <T> boolean isPKNotNull(T entity,String field){
		...
		Object value=null;
		try {
			value = ReflectionUtils.getFieldValue(entity, field);
