...
public class SysProvinceController extends BaseController <ISysProvinceService, SysProvince>{
    ...
    private ResultBeanFactory resultBeanFactory;
     ...
     @ApiImplicitParams({
    	...
    	@ApiImplicitParam(name = "sysProvinceDelFlag", value = "return-逻辑删除:0-未删除,1-已删除", required = false, dataType = "${dataType}"),
     })
     ...
     @ApiImplicitParam(name = "sysProvinceId", value = "ID", required = true, dataType = "String")
     @ApiImplicitParams({
    	@ApiImplicitParam(name = "sysProvinceId", value = "return-ID", required = false, dataType = "${dataType}"),
    	@ApiImplicitParam(name = "sysProvinceName", value = "return-lvM省名称", required = false, dataType = "String"),
    	@ApiImplicitParam(name = "sysProvinceDelFlag", value = "return-逻辑删除:0-未删除,1-已删除", required = false, dataType = "String"),
		})
